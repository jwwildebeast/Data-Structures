""" This is just  simple implementation of a Stack using a Linked List data structure in Python """
...
def push(self, new_item):
    ...
    self.list.prepend(new_node)       # Insert the node as the list head (top of the stack)


# Pop function
def pop(self):
    popped_item = self.list.head.data()     # Copy data from the list's head node (stack's top node)
